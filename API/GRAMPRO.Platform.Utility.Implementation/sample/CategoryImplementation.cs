...
{
    public class CategoryImplementation : ICategoryImplementation
    {
        ...
        public CategoryImplementation(ApplicationContext context, IConfigurationRoot config)
        {
        ...
        public Response getCategory()
        {
            try
            {
                ...
                _response.Data = this._context.tblCategory.ToList();
            ...
            try
            {
                if (sample.Category_Id > 0)
                {
                    ...
                    if (existingCategory != null)
                    {
                        ...
                        existingCategory.Department_Id = sample.Department_Id;
